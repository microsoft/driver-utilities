...
namespace Microsoft.CodeAnalysis.Driver.Sdk
{
    public abstract class ExportRulesMetadataCommandBase : DriverCommand<ExportRulesMetadataOptions>
    {
        ...
        public abstract IEnumerable<Assembly> DefaultExportAssemblies { get; }
        ...
        public override int Run(ExportRulesMetadataOptions exportOptions)
        {
            ...
            try
            {
                ImmutableArray<IRuleDescriptor> skimmers = DriverUtilities.GetExports<IRuleDescriptor>(DefaultExportAssemblies);
                ...
                switch (extension)
                {
                    ...
                    {
                        format = "SARIF";
                        ImmutableArray<IOptionsProvider> options = DriverUtilities.GetExports<IOptionsProvider>(DefaultExportAssemblies);
